...
class MapelController extends Controller
{
    ...
    public function index()
    {
        ...
        $mapel = Mapel::where('tahun_ajaran', isset($tahunajaran) ? $tahunajaran->nama : '0' )->OrderBy('angkatan', 'asc')->OrderBy('nama_mapel', 'asc')->get();
        $paket = Paket::all();
        return view('admin.mapel.index', compact('mapel', 'paket','tahunajaran'));
    }
