...
class JadwalUjian extends Model
{
  ...
  protected $fillable = ['tipe_ujian_id', 'mapel_id', 'guru_id', 'ruang_id', 'question_model_id', 'nama_kelas', 'tanggal', 'jam_mulai', 'jam_selesai', 'tahun_ajaran'];
  ...
  {
    return $this->belongsTo('App\QuestionModels')->withDefault();
  }

  public function tanggal()
  {
    return $this->belongsTo('App\Tanggal')->withDefault();
  }
