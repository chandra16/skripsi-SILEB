...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <form action="{{ route('nilai.store') }}" method="post">
            ...
            <div class="card-body">
                <div class="row">
                    <input type="hidden" name="id" value="{{ isset($nilai->id) ? $nilai->id : '' }}">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" required name="predikat_a" id="predikat_a" rows="4">{{ isset($nilai->deskripsi_a) ? $nilai->deskripsi_a : '' }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="predikat_c">Predikat C</label>
                            <textarea class="form-control" required name="predikat_c" id="predikat_c" rows="4">{{ isset($nilai->deskripsi_c) ? $nilai->deskripsi_c: '' }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" onkeypress="return inputAngka(event)" maxlength="2" value="{{ isset($nilai->kkm) ? $nilai->kkm : '' }}" id="kkm" name="kkm" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="predikat_b">Predikat B</label>
                            <textarea class="form-control" required name="predikat_b" id="predikat_b" rows="4">{{ isset($nilai->deskripsi_b) ? $nilai->deskripsi_b : '' }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="predikat_d">Predikat D</label>
                            <textarea class="form-control" required name="predikat_d" id="predikat_d" rows="4">{{ isset($nilai->deskripsi_d) ? $nilai->deskripsi_d: '' }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
