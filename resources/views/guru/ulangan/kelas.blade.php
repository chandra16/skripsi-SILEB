                ...
                <tbody>
                  @foreach ($kelas as $val => $data)
                    <tr>
                      ...
                      <td><a href="{{ route('guru.ulangan.addnilai',['id' => $data[0]->nama_kelas, 'tahunajaran' => $tahun->nama]) }}" class="btn btn-primary btn-sm"><i class="nav-icon fas fa-pen"></i> &nbsp; Entry Nilai</a></td>
                    </tr>
                  @endforeach
                </tbody>
              </table>
