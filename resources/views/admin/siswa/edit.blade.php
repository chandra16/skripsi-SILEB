    ...
    <div class="card card-primary">
      ...
      <form action="{{ route('siswa.update', $siswa->id) }}" method="post">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
                ...
                <input type="hidden" id="angkatan" name="angkatan" value="{{ $siswa->angkatan }}" class="form-control @error('angkatan') is-invalid @enderror">

                     <input type="hidden" id="tahun_ajaran" name="tahun_ajaran" value="{{ $siswa->tahun_ajaran }}" class="form-control @error('tahun_ajaran') is-invalid @enderror">
            </div>
            <div class="col-md-6">
                <div class="form-group">
        ...
        <div class="card-footer">
          <a href="{{ route('datasiswa.kelas.tahunajaran',['id' => $siswa->kelas_id, 'angkatan' => $siswa->angkatan,'tahunajaran' => $siswa->tahun_ajaran])}}" name="kembali" class="btn btn-default" id="back"><i class='nav-icon fas fa-arrow-left'></i> &nbsp; Kembali</a> &nbsp;
