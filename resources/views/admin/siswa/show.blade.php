...
@section('heading')
Data Siswa {{ isset($kelas[0]) ? $kelas[0]->nama_kelas : '' }}
@endsection
@section('page')
...
<div class="col-md-12">
    <div class="card">
       ...
       @if (Auth::user()->role == 'Admin')
            @if ($tahun_ajaran==$tahunajaran_latest->nama)
            <div class="card-header">
                <h3 class="card-title">
                    <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target=".bd-example-modal-lg">
                        <i class="nav-icon fas fa-folder-plus"></i> &nbsp; Tambah Data Siswa
                    </button>
                    <a href="{{ route('siswa.exportExcelByClass',['id' => isset($kelas[0]) ? $kelas[0]->nama_kelas : 'none' , 'tahunajaran' => isset($kelas[0]) ? $kelas[0]->tahun_ajaran : 'none' ]) }}" class="btn btn-success btn-sm my-3" target="_blank"><i class="nav-icon fas fa-file-export"></i> &nbsp; EXPORT EXCEL</a>
        ...
        <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form method="post" action="{{ route('siswa.import_excel_byclass',['id' => isset($kelas[0]) ? $kelas[0]->nama_kelas : 'none' , 'tahunajaran' => isset($kelas[0]) ? $kelas[0]->tahun_ajaran : 'none','angkatan'=>$tingkat ]) }}" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="dropTable" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form method="post" action="{{ route('siswa.deleteStudentByClass',isset($kelas[0]) ? $kelas[0]->id : '' ) }}">
                    @csrf
                    @method('delete')
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="angkatan" name="angkatan" value="{{$tingkat}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="hidden" id="tahun_ajaran" name="tahun_ajaran" value="{{isset($kelas[0]) ? $kelas[0]->tahun_ajaran : '' }}" class="form-control @error('tmp_lahir') is-invalid @enderror">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" id="kelas_id" name="kelas_id" value="{{isset($kelas[0]) ? $kelas[0]->nama_kelas : '' }}">
                    </div>
                    <div class="form-group">
