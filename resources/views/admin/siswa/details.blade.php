...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('datasiswa.kelas.tahunajaran',['id' => $siswa->kelas_id, 'angkatan' => $siswa->angkatan,'tahunajaran' => $siswa->tahun_ajaran])}}" class="btn btn-default btn-sm"><i class='nav-icon fas fa-arrow-left'></i> &nbsp; Kembali</a>
        </div>
        <div class="card-body">
