            ...
            <tbody>
                @foreach ($kelas as $data)
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('jadwal.showjadwal',['id' => $data->nama_kelas, 'tahunajaran' => $data->tahun_ajaran]) }}" class="btn btn-info btn-sm"><i class="nav-icon fas fa-search-plus"></i> &nbsp; Details</a>
                    </td>
                  </tr>
                @endforeach
            </tbody>
