            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                               ...
                               <a href="{{ route('admins.ulangan.addnilai',['id' => $data->nama_kelas, 'tahunajaran' => $data->tahun_ajaran])}}" class="btn btn-info btn-sm"><i class="fnav-icon fas fa-users"></i> &nbsp; View Siswa</a>
